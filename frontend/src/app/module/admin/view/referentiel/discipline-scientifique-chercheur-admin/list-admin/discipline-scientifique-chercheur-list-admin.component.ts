...
public async archiverDisciplineScientifiqueChercheur(disciplineScientifiqueChercheur: DisciplineScientifiqueChercheurVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueChercheur', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Discipline scientifique chercheur) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueChercheurService.archiver(disciplineScientifiqueChercheur).subscribe(status=>{
const myIndex = this.disciplineScientifiqueChercheurs.indexOf(disciplineScientifiqueChercheur);
this.disciplineScientifiqueChercheurs[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique chercheur archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverDisciplineScientifiqueChercheur(disciplineScientifiqueChercheur: DisciplineScientifiqueChercheurVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueChercheur', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Discipline scientifique chercheur) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueChercheurService.desarchiver(disciplineScientifiqueChercheur).subscribe(status=>{
const myIndex = this.disciplineScientifiqueChercheurs.indexOf(disciplineScientifiqueChercheur);
this.disciplineScientifiqueChercheurs[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique chercheur désarchivé',
life: 3000
});
},error=>console.log(error))
 }
