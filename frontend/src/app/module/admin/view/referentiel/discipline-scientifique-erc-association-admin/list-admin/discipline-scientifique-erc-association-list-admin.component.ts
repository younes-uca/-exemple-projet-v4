...
public async archiverDisciplineScientifiqueErcAssociation(disciplineScientifiqueErcAssociation: DisciplineScientifiqueErcAssociationVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueErcAssociation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Discipline scientifique erc association) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueErcAssociationService.archiver(disciplineScientifiqueErcAssociation).subscribe(status=>{
const myIndex = this.disciplineScientifiqueErcAssociations.indexOf(disciplineScientifiqueErcAssociation);
this.disciplineScientifiqueErcAssociations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique erc association archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverDisciplineScientifiqueErcAssociation(disciplineScientifiqueErcAssociation: DisciplineScientifiqueErcAssociationVo){
const isPermistted = await this.roleService.isPermitted('DisciplineScientifiqueErcAssociation', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Discipline scientifique erc association) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.disciplineScientifiqueErcAssociationService.desarchiver(disciplineScientifiqueErcAssociation).subscribe(status=>{
const myIndex = this.disciplineScientifiqueErcAssociations.indexOf(disciplineScientifiqueErcAssociation);
this.disciplineScientifiqueErcAssociations[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Discipline scientifique erc association désarchivé',
life: 3000
});
},error=>console.log(error))
 }
